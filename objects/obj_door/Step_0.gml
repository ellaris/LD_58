...
if(moving and cd <= 0 and mouse_check_button(mb_left) and array_length(a_coins) > 0 and point_in_rectangle(mouse_x,mouse_y,bbox_left,bbox_top,bbox_right,bbox_bottom))
{
